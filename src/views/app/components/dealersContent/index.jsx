        ...
        <>
          <section className="pb-5">
            <Container>
              ...
              <Col xs={12} sm={12} md={12} lg={10} xl={9}>
                ...
                <p className="text-center">Become the Dealer and Distributor of South India’s largest solid wood manufacturer of furniture that has been in the business for 80 years with an extensive range of products. - Join our Dealer network today and unlock new benefits</p>
              </Col>
              </Row>
            </Container>
          </section>
          ...
          <Container>
            ...
            <Col xs={12} sm={12} md={12} lg={7} xl={8}>
              <Row>
                <Col xs={12} sm={12} md={12} lg={10} xl={9}>
                <h2 className="heading2 mar-bot-20">Benefits Of Being A Hevea Furniture Dealer & Distributor</h2>
                </Col>
              </Row>
                
                <div className="dealers-list">                    
                    <ListGroup>
                        <ListGroup.Item><BsCheck2Circle /> Full control over the manufacturing process</ListGroup.Item>
                        ...
                        <ListGroup.Item><BsCheck2Circle /> Helping and making strategy planning for growth & expansion for all dealers and distributor</ListGroup.Item>
                        <ListGroup.Item><BsCheck2Circle /> Sales Support, EMI facilities for end users</ListGroup.Item>
                        <ListGroup.Item><BsCheck2Circle /> High Value Ticket business</ListGroup.Item>
                        <ListGroup.Item><BsCheck2Circle /> 100 % Billing through dealer & distributor network</ListGroup.Item>
                        <ListGroup.Item><BsCheck2Circle /> Different Schemes</ListGroup.Item>
                        <ListGroup.Item><BsCheck2Circle /> Online lead generation support</ListGroup.Item>
                    ...
                    <Link to="/" className="orange-btn mb-4">Enquire Now <BsArrowRight /></Link>
                </div>
            </Col>
