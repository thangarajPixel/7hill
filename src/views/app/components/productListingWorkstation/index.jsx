                ...
                <Container>
                    <Row>
                        ...
                        <Col xs={12} sm={12} md={12} lg={6} xl={5}>
                            <div>
                                <h3 className="heading3">Two Seater Workstation with Fabric Screen - Natural Finish</h3>
                    ...
                    <div className="px-3 mob-pad-bot-20">
                        ...
                        <Form>
                            ...
                            <Form.Group className="mar-bot-30" controlId="product">
                                <Form.Control type="text" value="Two Seater Workstation with Fabric Screen - Natural Finish" disabled />
                            </Form.Group>
...
const ProductListingWorkstation = () => {
                    ...
                    <Row className="justify-content-center">
                        <Col xs={12} sm={6} md={6} lg={4} xl={3}>
                            <div className="products-div">
                                <img src={WorkstationImage1} alt="" className="img-fluid w-100" />
                                <p>Two Seater Workstation  with Fabric Screen - Natural Finish</p>
                        ...
                        <Col xs={12} sm={6} md={6} lg={4} xl={3}>
                            <div className="products-div">
                                <img src={WorkstationImage2} alt="" className="img-fluid w-100" />
                                <p>Linear Workstation with Fabric Privacy Screen - Natural Finish</p>
                                <div className="products-buttons">
                                    <Button className="view-btn" onClick={() => setModalShow(true)}>View Details</Button>
                                    <Button className="enquire-btn" onClick={() => setModalShow1(true)}>Enquire Now</Button>
                                </div>
                        ...
                        <Col xs={12} sm={6} md={6} lg={4} xl={3}>
                            <div className="products-div">
                                <img src={WorkstationImage3} alt="" className="img-fluid w-100" />
                                <p>Four Seater Workstation with  Privacy Screen - Natural Finish</p>
                                <div className="products-buttons">
                                    <Button className="view-btn" onClick={() => setModalShow(true)}>View Details</Button>
                                    <Button className="enquire-btn" onClick={() => setModalShow1(true)}>Enquire Now</Button>
                                </div>
                        ...
                        <Col xs={12} sm={6} md={6} lg={4} xl={3}>
                            <div className="products-div">
                                <img src={WorkstationImage4} alt="" className="img-fluid w-100" />
                        ...
                        <Col xs={12} sm={6} md={6} lg={4} xl={3}>
                            <div className="products-div">
                                <img src={WorkstationImage3} alt="" className="img-fluid w-100" />
                                <p>Two Seater - Linear back to back Workstation - Natural Finish</p>
                                <div className="products-buttons">
                                    <Button className="view-btn" onClick={() => setModalShow(true)}>View Details</Button>
                                    <Button className="enquire-btn" onClick={() => setModalShow1(true)}>Enquire Now</Button>
                                </div>
