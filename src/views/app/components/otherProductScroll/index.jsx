          ...
          <Row>
            <Col className="other-products-slider">
              <Slider {...settings}>
                ...
                <Link
                  to="/home-furniture/sofas-armchairs"
                ...
                <Link
                  to="/home-furniture/dinning-tables"
                  className="product-list"
                >
                  <div className="blog-img">
                    <img
                ...
                <Link
                  to="/home-furniture/dinning-chairs"
                  className="product-list"
                >
                  <div className="blog-img">
                    <img
                ...
                <Link
                  to="/home-furniture/center-table"
                  className="product-list"
                >
                  <div className="blog-img">
                ...
                <Link
                  to="/home-furniture/pooja-mandapam"
                  className="product-list"
                >
                  <div className="blog-img">
                    <img
