            ...
            <Col xs={12} sm={12} md={12} lg={6} xl={6}>
                <div className="home-furnish">
                    ...
                    <div className="home-furnish-content">
                        ...
                        <p className="text-white mar-bot-30 mt-3">We are the one-stop solution for your Institutional Furniture requirements. Get in touch with us for corporate bulk enquiries. </p>
                        <Link to="/contact" className="orange-btn hover-white">Get in Touch Now <BsArrowRight /></Link>
                    </div>
                </div>
            </Col>
            <Col xs={12} sm={12} md={12} lg={6} xl={6}>
                <div className="home-furnish">
                    ...
                    <div className="home-furnish-content left-align">
                        ...
                        <p className="text-white mar-bot-30 mt-3">We are the one-stop solution for your Home Furniture requirements. Get in touch with us now for bulk enquiries.</p>
                        <Link to="/contact" className="orange-btn hover-white">Get in Touch Now <BsArrowRight /></Link>
                    </div>
                </div>
            </Col>
